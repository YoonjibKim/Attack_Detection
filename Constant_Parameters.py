...
SAMPLING_LOSS_RATE = 'sampling_loss_rate'
...
CS_ANALYSIS_FILE_NAME = 'cs_analysis.json'
CS_FEATURE_FILE_NAME = 'cs_feature.json'
GS_ANALYSIS_FILE_NAME = 'gs_analysis.json'
GS_FEATURE_FILE_NAME = 'gs_feature.json'

ML_FEATURE_FILE_NAME = 'cs_ml_feature'

BEST_SCORE_FILE_NAME = 'best_score.json'
...
BEST_FEATURE_PATH = 'Best_Feature'
F1_SCORE_PATH = 'F1_Score'
STATISTICS_PATH = 'Statistics'

TOTAL_BEST_SCORE_FILENAME = 'total_best_score.csv'
TOTAL_WORST_SCORE_FILENAME = 'total_worst_score.csv'
...
SCENARIO_LOSS_RATE_FILENAME = 'scenario_loss_rate.json'

CS_STATION_SAMPLING_SCORE = 'cs_station_sampling_score.json'
GS_STATION_SAMPLING_SCORE = 'gs_station_sampling_score.json'
